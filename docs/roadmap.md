...
| 4 | MinIO + signed-URL upload flow + checksum-validated object storage | **done** | [spec](./superpowers/specs/2026-05-07-slice-4-minio-storage-design.md) · [plan](./superpowers/plans/2026-05-07-slice-4-minio-storage.md) | Completed 2026-05-12. Sidecar to Orthanc; best-effort failure mode. |
